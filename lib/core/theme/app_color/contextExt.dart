...
extension AppColorsX on BuildContext {
  ...
  // ── Background ────────────────────────────────────────────
  Color get bgColor => isDark ? AppColorDark.background : AppColorLight.background;
  ...
  // ── Input Fields ──────────────────────────────────────────
  Color get fieldBg          => isDark ? AppColorDark.fieldBackground  : AppColorLight.fieldBackground;
  Color get fieldBorder      => isDark ? AppColorDark.fieldBorder      : AppColorLight.fieldBorder;
  Color get fieldPlaceholder => isDark ? AppColorDark.fieldPlaceholder : AppColorLight.fieldPlaceholder;
  Color get fieldText        => isDark ? AppColorDark.fieldText        : AppColorLight.fieldText;

  // ── Bottom Navigation Bar ─────────────────────────────────
  Color get barBg           => isDark ? AppColorDark.barBackground   : AppColorLight.barBackground;
  Color get barActiveIcon   => isDark ? AppColorDark.barActiveIcon   : AppColorLight.barActiveIcon;
  Color get barInactiveIcon => isDark ? AppColorDark.barInactiveIcon : AppColorLight.barInactiveIcon;

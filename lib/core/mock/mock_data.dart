...
class MockData {
  ...
  static const mock2FASetup = {
    'qrCodeUrl': 'otpauth://totp/SecureMail:mohamed@securemail.com?secret=MOCK_SECRET&issuer=SecureMail',
  ...
  static const mockInboxEmails = [
    {
      ...
      'bodyText':        'Please review the attached Q1 security report and take necessary action.',
  ...
  static const mockSpamEmails = [
    {
      ...
      'to':              'mohamed@gmail.com',
      'bodyText':        'Congratulations! You have been selected to win an amazing prize.',
      'isRead':          false,
      'classification':  'spam',
  ...
  static const mockPhishingEmails = [
    {
      ...
      'to':              'mohamed@gmail.com',
      'bodyText':        'Click here to verify your account immediately or it will be suspended.',
      'isRead':          false,
  ...
  static const mockNotifications = [
    ...
    },
    {
      ...
      'message':   'Your weekly security report is ready. 47 threats were blocked.',
